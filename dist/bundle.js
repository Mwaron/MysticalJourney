(() => {
  ...
  var init_consts = __esm({
    "node_modules/animejs/dist/modules/core/consts.js"() {
      ...
      isRegisteredTargetSymbol = /* @__PURE__ */ Symbol();
      isDomSymbol = /* @__PURE__ */ Symbol();
      isSvgSymbol = /* @__PURE__ */ Symbol();
      transformsSymbol = /* @__PURE__ */ Symbol();
      proxyTargetSymbol = /* @__PURE__ */ Symbol();
      minValue = 1e-11;
      maxValue = 1e12;
      K = 1e3;
      maxFps = 120;
  ...
  var init_globals = __esm({
    "node_modules/animejs/dist/modules/core/globals.js"() {
      ...
      globalVersions = { version: "4.2.2", engine: null };
      if (isBrowser) {
  ...
  var toLowerCase, stringStartsWith, now, isArr, isObj, isNum, isStr, isFnc, isUnd, isNil, isSvg, isHex, isRgb, isHsl, isCol, isKey, svgCssReservedProperties, isValidSVGAttribute, pow, sqrt, sin, cos, floor, asin, PI, _round, clamp, powCache, round, lerp, clampInfinity, normalizeTime, cloneArray, mergeObjects, forEachChildren, removeChild, addChild;
  ...
  var rgbToRgba, hexToRgba, hue2rgb, hslToRgba, convertColorStringValuesToRgbaArray;
  ...
  var additive, addAdditiveAnimation;
  var init_additive = __esm({
    "node_modules/animejs/dist/modules/animation/additive.js"() {
      init_consts();
      init_helpers();
      init_render();
  ...
  var engineTickMethod, engineCancelMethod, Engine, engine, tickEngine, killEngine;
  ...
  var lookups, getTweenSiblings, addTweenSortMethod, overrideTween, composeTween, removeTweenSliblings;
  ...
  var angleUnitsMap, convertedValuesCache, convertValueUnit;
  ...
  var easeInPower, easeTypes, halfPI, doublePI, easeInFunctions, eases, easesLookups, parseEaseString, deprecated, parseEase;
  ...
  var fromTargetObject, toTargetObject, inlineStylesStore, toFunctionStore, keyframesTargetArray, fastSetValuesArray, keyObjectTarget, tweenId, keyframes, key, generateKeyframes, JSAnimation, animate;
